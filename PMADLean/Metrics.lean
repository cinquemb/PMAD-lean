...
/-- Resonance Monotonicity.
    ...
    resonance profile entry (R_ij > R_ik) under an admissible Ubiquitous Resonance framework
    (Axiom A4) translates directly into a strictly stronger DynamicSpatialAdjacency coupling weight. -/
